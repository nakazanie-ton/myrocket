...
- Release assets: `xrocket-mcp-0.6.0.tgz`, `xrocket-exchange-codex-plugin.zip`, and Gemini CLI archives for macOS, Linux, and Windows. Their GitHub-verified SHA-256 values are `58db31d2af3fd38a8fb44514282bbcfd5c7be3315fea5f19a96306dfa5143a9a`, `ba1f45be7c4c02c5d46d687640ac75e1cb660ad319a04d34ec1413428a4028e9`, `c7afed6c48f892e9b0c4260c103e9c91d1cc5c910f40889d7405082c217ebde6` for both tarballs, and `fec679f575774b5013160e7601d7d27b177c833485fb4779df038e2cf2476840` for the Windows ZIP.
...
- GitHub Awesome Copilot submission: [`github/awesome-copilot#2796`](https://github.com/github/awesome-copilot/issues/2796); the external Agent Plugin intake passed spec compliance, skill lint, Copilot CLI installation, and version matching and is ready for maintainer review. The same plugin can already be installed directly with `copilot plugin install nakazanie-ton/myrocket:plugins/xrocket-exchange`.
- Gemini CLI extension: the root `gemini-extension.json` connects to the hosted public-only endpoint, and an isolated direct install passed on Gemini CLI 0.39.1 using the platform-specific v0.6.0 release archive. The `gemini-cli-extension` repository topic enables automatic daily Gallery discovery without a separate submission form.
...
| P1 | GitHub Awesome Copilot | [`github/awesome-copilot#2796`](https://github.com/github/awesome-copilot/issues/2796) | **Submitted; official intake and all required quality gates passed; ready for review** | Direct Copilot CLI install already works; await maintainer approval for default marketplace discovery |
| P1 | Gemini CLI Gallery | Root `gemini-extension.json`, platform release archives, and GitHub topic `gemini-cli-extension` | **Direct install verified on 0.39.1; discovery topic enabled** | Verify automatic Gallery ingestion after the next daily crawl |
...
2. Keep Glama, Smithery MCP, Smithery Skills, and the Gemini CLI extension current and follow the submitted Docker MCP Catalog, Kilo Marketplace, GitHub Awesome Copilot, Cline, OpenModels, `awesome-mcp-servers`, mcp.so, MCP Market, mcpservers.org, FutureTools, and MCP.Directory reviews through to public listings.
